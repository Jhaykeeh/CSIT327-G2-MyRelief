...
SUPABASE_KEY = os.getenv("SUPABASE_KEY")  # Use 'anon' key for client-side, 'service_role' key to bypass RLS
SUPABASE_SERVICE_ROLE_KEY = os.getenv("SUPABASE_SERVICE_ROLE_KEY")  # Optional: For backend operations that need to bypass RLS
